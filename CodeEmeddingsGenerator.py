'''
TODO Next steps
- Different file for each token
- Directories corresopnding to ant-ivy dir. This will help preserve directory structure in a more convenient way, I think
- Folder for each java file
- Any subdirectories with no java files will persist, only empty
- 1 json = 1 element (token, class, ...)
- filename_class_method.json
- whyyyyyy
'''
